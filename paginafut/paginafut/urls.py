...
from eva3.views import index,registrarpartido,listapartidos,modificarpartido,eliminarpartido,registrousuario,crear_comentario,ver_comentarios, actualizar_comentario,eliminar_comentario,lista_comentarios
